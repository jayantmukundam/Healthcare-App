            ...
            <IonContent className='ion-padding'/*class = "content-style"*/>
                <IonCard class = "card-style">
                    <IonGrid className='ion-text-center ion-margin' >
                        ...
                        <IonList>
                            <IonItem>
                                <IonSelect interface="action-sheet" placeholder="Select Hospital " onClick={handle} onIonChange={selectHospital}>
                                {
...
export default GlobalRegisterSupervisor;
