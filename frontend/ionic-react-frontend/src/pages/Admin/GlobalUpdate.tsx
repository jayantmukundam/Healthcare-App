           ...
           <IonContent className='ion-padding'>
                <IonGrid className='ion-text-center ion-margin ion-padding'>
                    <IonCard class = "card-style">
                        <IonCardHeader>
                            <IonCardTitle class = "ion-card-title-style"><IonButton fill = "clear" size = "large" class = "btn" routerLink = "./globalUpdate/globalUpdateHospital">HOSPTIAL</IonButton></IonCardTitle>
                        </IonCardHeader>
                    </IonCard>
