        ...
        <IonPage>
            ...
            <IonContent className='ion-padding' /*class = "content-style"*/>
                <IonGrid className='ion-text-center ion-margin'>
                    ...
                    <RegisterCard location = {"/supervisors/delete/deleteDoctor"} actor = {"DELETE DOCTOR"} data = {profileData.userData}></RegisterCard>
                    <RegisterCard location = {"/supervisors/delete/deleteFieldWorker"} actor = {"DELETE FIELD WORKER"} data = {profileData.userData}></RegisterCard>
